...
def simulate_fvg_trade(candles: list[dict], fvg, r_multiple: float) -> TradeOutcome | None:
    ...
    # TP mesafesinin %60'i kat edilince SL girise cekilir -- sonra donerse
    # -1R degil 0R (breakeven) sayilir. Ayni-bar belirsizligini onlemek icin
    # bu barin SL kontrolu HER ZAMAN bir onceki bardan kalma effective_sl ile
    # yapilir, arm islemi sadece SONRAKI bar icin gecerli olur.
